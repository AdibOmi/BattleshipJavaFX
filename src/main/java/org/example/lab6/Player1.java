...
public class Player1 {
    ...
    void colorGreen(int r, int c) {
        Button button = (Button) grid1.getChildren().get((r * 9) + c + 1);
    ...
    public void proceedB(ActionEvent e1) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("Player2.fxml"));
        Stage stage = (Stage) ((Button) e1.getSource()).getScene().getWindow();
